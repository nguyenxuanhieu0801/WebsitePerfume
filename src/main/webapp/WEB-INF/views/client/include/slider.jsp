	...
	<div class="wrap-slick1">
		...
		<!-- 
			<div class="item-slick1"
				style="background-image: url(/template/images/slide-01.jpg)">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false"
							data-appear="fadeInDown" data-delay="0">
							<span class="ltext-101 cl2 respon2"> Women Collection 2018
							</span>
						</div>
			...
			<!-- 
			<div class="item-slick1"
				style="background-image: url(/template/images/slide-02.jpg)">
				<div class="container h-full">
					<div class="flex-col-l-m h-full p-t-100 p-b-30 respon5">
						<div class="layer-slick1 animated visible-false"
...
--> 
			<div class="item-slick1"
				style="background-image: url(https://i.pinimg.com/originals/31/c5/48/31c548c369ae5224356d320b6c024971.jpg)">
				<div class="container h-full">
